...
def on_exception(state, function_name: str, ex: Exception) -> None:
    ...
    Args:
        ...
        function_name (str): Name of function where exception occurred
...
def selelct_conv(state: State, var_name: str, value) -> None:
    """
...
if __name__ == "__main__":
    ...
    Gui(page).run(debug=True, dark_mode=True, user_reloader=True, title="💬 Taipy Chat")
