...
# message_text = [
#     {"role": "system", "content": "You are a helpful, creative, clever, and very friendly assistant that helps people find information." },
#     {"role": "user", "content": "Hello, who are you?" },
#     {"role": "assistant", "content": "Hi! I am GPT-4. How can I help you today?" }
# ]
...
def request(state: State, prompt: str) -> str:
    ...
    """
    # response = state.client.chat.completion.create(
...
if __name__ == "__main__":
    ...
    client = AzureOpenAI(
    azure_endpoint=os.environ["AZ_ENDPOINT"],
    api_key=os.environ["OPENAI_API_KEY"],
